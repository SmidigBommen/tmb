...
const REFUGES = [
    ...
    { name: 'Camping Le Bellevue', altitude: 1007, capacity: 100, price: '~EUR 12-20', country: 'France', stage: 1, lat: 45.8910, lng: 6.7970, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Right in Les Houches. Hot showers, small shop. Great start/end point.', amenities: ['Tent pitch', 'Hot showers', 'Shop'] },
    { name: 'Camping Le Pontet', altitude: 1164, capacity: 80, price: '~EUR 10-18', country: 'France', stage: 1, lat: 45.8210, lng: 6.7280, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Village campsite in Les Contamines. Basic but well-located.', amenities: ['Tent pitch', 'Hot showers', 'Village access'] },
    { name: 'Camping Auberge de la Nova', altitude: 1549, capacity: 30, price: '~EUR 10-15', country: 'France', stage: 2, lat: 45.7130, lng: 6.7310, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Small camping area next to the auberge in Les Chapieux. Limited spots.', amenities: ['Tent pitch', 'Meals available', 'Basic facilities'] },
    { name: 'Camping Monte Bianco', altitude: 1224, capacity: 120, price: '~EUR 15-25', country: 'Italy', stage: 4, lat: 45.7930, lng: 6.9680, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Well-equipped campsite near Courmayeur. Supermarket and restaurants nearby.', amenities: ['Tent pitch', 'Hot showers', 'Laundry', 'Restaurant'] },
    { name: 'Camping Aiguille Noire', altitude: 1320, capacity: 60, price: '~EUR 12-20', country: 'Italy', stage: 5, lat: 45.8050, lng: 6.9750, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Quiet site in Val Ferret. Spectacular mountain backdrop.', amenities: ['Tent pitch', 'Hot showers', 'Bar'] },
    { name: 'Camping des Glaciers', altitude: 1593, capacity: 80, price: '~CHF 15-22', country: 'Switzerland', stage: 6, lat: 45.9335, lng: 7.0960, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Beautiful setting in La Fouly. Clean facilities, mountain views.', amenities: ['Tent pitch', 'Hot showers', 'Kitchen'] },
    { name: 'Camping du Grand Combin', altitude: 1466, capacity: 60, price: '~CHF 15-20', country: 'Switzerland', stage: 7, lat: 46.0300, lng: 7.1180, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Lakeside camping at Champex-Lac. Scenic and peaceful.', amenities: ['Tent pitch', 'Hot showers', 'Lake access'] },
    { name: 'Camping Relais du Mont Blanc', altitude: 1526, capacity: 40, price: '~CHF 12-18', country: 'Switzerland', stage: 8, lat: 46.0570, lng: 7.0170, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Camping area at Col de la Forclaz. Basic but well-positioned.', amenities: ['Tent pitch', 'Meals available'] },
    { name: 'Camping Le Peuty', altitude: 1328, capacity: 30, price: '~CHF 12-15', country: 'Switzerland', stage: 8, lat: 46.0535, lng: 7.0245, bookingUrl: 'https://refugelepeuty.ch/en/', image: null, tier: 'budget', notes: 'Camping alongside the refuge. Yurt option also available.', amenities: ['Tent pitch', 'Meals at refuge', 'Yurt'] },
    { name: 'Camping Le Glacier d\'Argentiere', altitude: 1250, capacity: 70, price: '~EUR 12-20', country: 'France', stage: 9, lat: 45.9810, lng: 6.9280, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'budget', notes: 'Near Argentiere village. Access to shops and transport.', amenities: ['Tent pitch', 'Hot showers', 'Laundry', 'Village access'] },

    // === COMFORT: Hotels & Guesthouses ===
    { name: 'Hotel Saint-Antoine', altitude: 1007, capacity: 40, price: '~EUR 120-180', country: 'France', stage: 1, lat: 45.8900, lng: 6.7985, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Charming hotel in Les Houches. Restaurant, garden, Mont Blanc views.', amenities: ['Private room', 'Restaurant', 'WiFi', 'Garden'] },
    { name: 'Hotel Gai Soleil', altitude: 1164, capacity: 50, price: '~EUR 90-140', country: 'France', stage: 1, lat: 45.8215, lng: 6.7275, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Family-run hotel in Les Contamines. Pool and spa facilities.', amenities: ['Private room', 'Restaurant', 'Pool', 'WiFi'] },
    { name: 'Auberge de la Nova', altitude: 1549, capacity: 20, price: '~EUR 75-100', country: 'France', stage: 2, lat: 45.7128, lng: 6.7308, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'The only lodging option in tiny Les Chapieux. Comfortable private rooms.', amenities: ['Private room', 'Restaurant', 'Half-board'] },
    { name: 'Hotel Bouton d\'Or', altitude: 1224, capacity: 55, price: '~EUR 130-200', country: 'Italy', stage: 4, lat: 45.7920, lng: 6.9670, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Elegant hotel in Courmayeur center. Spa, excellent restaurant. Perfect for rest day.', amenities: ['Private room', 'Restaurant', 'Spa', 'WiFi', 'Bar'] },
    { name: 'Auberge de la Maison', altitude: 1300, capacity: 45, price: '~EUR 150-250', country: 'Italy', stage: 4, lat: 45.7880, lng: 6.9610, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Upscale chalet-style hotel near Courmayeur. Wellness center, gourmet dining.', amenities: ['Private room', 'Spa', 'Gourmet restaurant', 'WiFi', 'Wellness'] },
    { name: 'Hotel Edelweiss', altitude: 1593, capacity: 30, price: '~CHF 140-200', country: 'Switzerland', stage: 6, lat: 45.9330, lng: 7.0950, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Comfortable hotel in La Fouly. Mountain views, hearty Swiss cuisine.', amenities: ['Private room', 'Restaurant', 'WiFi', 'Terrace'] },
    { name: 'Hotel Splendide', altitude: 1466, capacity: 50, price: '~CHF 150-220', country: 'Switzerland', stage: 7, lat: 46.0295, lng: 7.1170, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Lakeside hotel in Champex-Lac. Beautiful terrace overlooking the lake.', amenities: ['Private room', 'Restaurant', 'Lake views', 'WiFi', 'Terrace'] },
    { name: 'Hotel Col de la Forclaz', altitude: 1526, capacity: 25, price: '~CHF 120-170', country: 'Switzerland', stage: 8, lat: 46.0560, lng: 7.0165, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Historic mountain pass hotel. Restaurant with panoramic terrace.', amenities: ['Private room', 'Restaurant', 'WiFi', 'Panoramic terrace'] },
    { name: 'Hotel Grands Montets', altitude: 1250, capacity: 40, price: '~EUR 130-190', country: 'France', stage: 9, lat: 45.9815, lng: 6.9275, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Modern hotel in Argentiere. Close to cable car and restaurants.', amenities: ['Private room', 'Restaurant', 'WiFi', 'Bar'] },
    { name: 'Hotel Le Faucigny', altitude: 1035, capacity: 60, price: '~EUR 140-220', country: 'France', stage: 11, lat: 45.9237, lng: 6.8694, bookingUrl: 'https://www.montourdumontblanc.com/en/', image: null, tier: 'comfort', notes: 'Boutique hotel in Chamonix center. Perfect end-of-trek celebration.', amenities: ['Private room', 'Restaurant', 'Spa', 'WiFi', 'Bar'] },
];
